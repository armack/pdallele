...
### Manual Country/Territory Standardization
Manually correct country (or territory) names and ISO 3166-1 Alpha-3 codes in
cases where the INSDC controlled vocabulary names don't align well with the name
variants used in the `countrycode` R package This is optional, but may help to
increase the number of geographic entities included in later analysis steps.
...
manual_iso3c <- c(
  ...
  "Jarvis Island" = "UMI",
  "Johnston Atoll" = "UMI",
  "Juan de Nova Island" = "ATF",
  "Kerguelen Archipelago" = "ATF",
  "Kingman Reef" = "UMI",
  "Micronesia" = "FSM",
  "Midway Islands" = "UMI",
  "Navassa Island" = "UMI",
...
mbe_raw <- import_microbigge_gcp(microbigge_path) %>%
  ...
  parse_bla_formatting(gene = FALSE) %>%
