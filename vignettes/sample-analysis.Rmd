...
for (i in 1:nrow(combinations)) {
  ...
  mlst_presence_frequency <- mlst_presence %>%
    ...
    mutate(porportion = isolates / length(unique(mlst_presence$mlst))) %>%
    mutate(rank = dplyr::dense_rank(desc(isolates))) %>%
    left_join(isolates %>%
                filter_assigned_bla() %>%
                filter_attribute(allele, gene_filter) %>%
  ...
  pds_presence_frequency <- pds_presence %>%
    ...
    mutate(porportion = isolates / length(unique(mlst_presence$pds))) %>%
    mutate(rank = dplyr::dense_rank(desc(isolates))) %>%
    left_join(isolates %>%
                filter_assigned_bla() %>%
                filter_attribute(allele, gene_filter) %>%
  ...
  pds_unclustered_frequency <- pds_unclustered %>%
    ...
    mutate(porportion = isolates / length(unique(mlst_presence$biosample))) %>%
    mutate(rank = dplyr::dense_rank(desc(isolates))) %>%
    left_join(isolates %>%
                filter_assigned_bla() %>%
                filter_attribute(allele, gene_filter) %>%
  ...
  pds_presence_unclustered_frequency <- pds_presence_unclustered %>%
    ...
    mutate(porportion = isolates / (length(unique(pds_presence_unclustered$pds)) + (pds_presence_unclustered %>% filter(is.na(pds)) %>% distinct(biosample) %>% nrow()))) %>%
    mutate(rank = dplyr::dense_rank(desc(isolates))) %>%
    left_join(isolates %>%
                filter_assigned_bla() %>%
                filter_attribute(allele, gene_filter) %>%
...
for (i in 1:nrow(combinations)) {
  ...
  pds_presence_frequency <- pds_presence %>%
    ...
    mutate(porportion = isolates / length(unique(pds_presence$pds))) %>%
  mutate(rank = dplyr::dense_rank(desc(isolates))) %>%
    left_join(isolates %>%
                filter_assigned_bla() %>%
                filter_attribute(allele, gene_filter) %>%
...
for (i in 1:nrow(combinations)) {
  ...
  bioproject_deduplicated_frequency <- bioproject_deduplicated %>%
    ...
    mutate(porportion = isolates / length(unique(bioproject_deduplicated$biosample))) %>%
    mutate(rank = dplyr::dense_rank(desc(isolates))) %>%
    full_join(isolates %>%
                filter_assigned_bla() %>%
                filter_attribute(allele, gene_filter) %>%
...
for (i in 1:nrow(combinations)) {
  ...
  bioproject_presence_frequency <- bioproject_presence %>%
    ...
    mutate(porportion = isolates / length(unique(bioproject_presence$biosample))) %>%
    mutate(rank = dplyr::dense_rank(desc(isolates))) %>%
    full_join(isolates %>%
                filter_assigned_bla() %>%
                filter_attribute(allele, gene_filter) %>%
