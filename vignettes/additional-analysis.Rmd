...
ab_mbe %>%
  dplyr::left_join(ab %>% distinct(biosample, period, period_2000), by = "biosample") %>%
...
pa_mbe %>%
  filter(year == 2018 | year == 2019) %>%
  filter(subclass == "CARBAPENEM") %>%
  left_join(pa %>% distinct(biosample, bioproject), by = "biosample") %>%
  filter(bioproject != "PRJNA824880") %>%
  count_isolates(mlst)
```
...
ab %>%
  summarize(
    pop_2017 = n_distinct(biosample[year == 2017 & bioproject == "PRJNA906166"]),
    pop_2018 = n_distinct(biosample[year == 2018 & bioproject == "PRJNA906166"]),
    pop_2019 = n_distinct(biosample[year == 2019 & bioproject == "PRJNA906166"]),
    pop_total = n_distinct(biosample[bioproject == "PRJNA906166" & year %in% 2017:2019]),
    nonpop_2017 = n_distinct(biosample[year == 2017 & bioproject != "PRJNA906166"]),
    nonpop_2018 = n_distinct(biosample[year == 2018 & bioproject != "PRJNA906166"]),
    nonpop_2019 = n_distinct(biosample[year == 2019 & bioproject != "PRJNA906166"]),
    nonpop_total = n_distinct(biosample[bioproject != "PRJNA906166" & year %in% 2017:2019]),
    overall_2017 = n_distinct(biosample[year == 2017]),
    overall_2018 = n_distinct(biosample[year == 2018]),
    overall_2019 = n_distinct(biosample[year == 2019]),
    overall_total = n_distinct(biosample[year %in% 2017:2019])
  )
...
#blaOXA-23 allele-containing isolate coun
ab %>%
  filter(year %in% 2017:2019) %>%
  filter(bioproject != "PRJNA906166") %>%
  filter(subclass == "CARBAPENEM") %>%
