...
ab %>%
  summarize(
    snap_2017 = n_distinct(biosample[year == 2017 & bioproject == "PRJNA906166"]),
    snap_2018 = n_distinct(biosample[year == 2018 & bioproject == "PRJNA906166"]),
    snap_2019 = n_distinct(biosample[year == 2019 & bioproject == "PRJNA906166"]),
    snap_total = n_distinct(biosample[bioproject == "PRJNA906166" & year %in% 2017:2019]),
    nonsnap_2017 = n_distinct(biosample[year == 2017 & bioproject != "PRJNA906166"]),
    nonsnap_2018 = n_distinct(biosample[year == 2018 & bioproject != "PRJNA906166"]),
    nonsnap_2019 = n_distinct(biosample[year == 2019 & bioproject != "PRJNA906166"]),
    nonsnap_total = n_distinct(biosample[bioproject != "PRJNA906166" & year %in% 2017:2019]),
